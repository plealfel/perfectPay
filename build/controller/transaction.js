...
const createPixPayment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const paymentResponse = yield transactionService_1.default.createPixPayment(paymentData);
...
const createCreditCardPayment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const paymentData = req.body;
        const paymentResponse = yield transactionService_1.default.createCreditCardPayment(paymentData);
        res.status(200).json(paymentResponse);
    }
    catch (error) {
        if (error instanceof Error) {
...
const createBoletoPayment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const paymentData = req.body;
        const paymentResponse = yield transactionService_1.default.createBoletoPayment(paymentData);
        res.status(200).json(paymentResponse);
    }
    catch (error) {
        if (error instanceof Error) {
